...
const editItem = (id: string) => store.dispatch(actionType.EDIT_ITEM, id);

const toogleCompled = (id: string) =>
  store.dispatch(actionType.TOOGLE_COMPLETE, id);

const deleteItem = (id: string) => store.dispatch(actionType.DELETE_ITEM, id);
</script>
